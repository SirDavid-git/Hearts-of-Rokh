...
NProduction = {
	...
	CONVOY_MAX_NAV_FACTORIES_PER_LINE = 200,
	...
	MIN_POSSIBLE_TRAINING_MANPOWER = 2000000,	-- How many deployment lines minimum can be training
...
NMilitary = {
	...
	ENEMY_AIR_SUPERIORITY_DEFENSE = 0.55,	       -- more AA attack will approach this amount of help (diminishing returns)
	...
	ANTI_AIR_ATTACK_TO_AMOUNT = 0.0035,				-- Balancing value to convert equipment stat anti_air_attack to the random % value of airplanes being hit.																																																																
...
NAir = {
	...
	ANTI_AIR_PLANE_DAMAGE_FACTOR = 0.60,					-- Anti Air Gun Damage factor
	...
	CAS_NIGHT_ATTACK_FACTOR = 0.4,                      -- CAS damaged get multiplied by this in land combats at night
